...
const (
	...
	CommunityTable = "community_category_mapping"
...
var (
	...
	CommunityPrimaryKey = []string{"community_category_id", "community_id"}
)
...
// OrderOption defines the ordering options for the CommunityCategory queries.
